...
use App\Filament\Exports\Reports\BatchReportExporter;
use App\Models\User;
...
class ExportBatchReportJob implements ShouldQueue
{
    ...
    public function handle(BatchReportExporter $exporter)
    {
