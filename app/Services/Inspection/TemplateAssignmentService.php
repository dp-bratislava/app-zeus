...
class TemplateAssignmentService
{
    ...
    public function setSubject(InspectionTemplate $inspectionTemplate, Model $subject): ?InspectionTemplateAssignment
    {
    ...
    public function getSubjectsByTemplate(InspectionTemplate $inspectionTemplate, ?array $subjectTypes): Collection
    {
        return $this->inspectionTemplateAssignment
            ->with('subject')
            ->where('template_id', '=', $inspectionTemplate->id)
