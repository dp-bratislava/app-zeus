...
class TaskTemplateGroupImporter extends Importer
{
    ...
    {
        $body = 'Your task template group import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
