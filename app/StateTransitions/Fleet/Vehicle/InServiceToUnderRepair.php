...
class InServiceToUnderRepair extends Transition
{
    ...
    public function canTransition(): bool
    {
        ...
        $userCan = true;
        $validInitialState = $this->vehicle->state->equals(InService::class);
    ...
    public function handle(): ?Vehicle
    {
        if ($this->canTransition()) {
            ...
            $this->vehicle->state = new UnderRepair($this->vehicle);
            $this->vehicle->save();
