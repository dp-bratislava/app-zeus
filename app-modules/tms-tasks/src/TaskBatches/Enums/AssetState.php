...
enum AssetState: string implements AssetStateInterface, HasLabel
{
    case NA_VYRADENIE = 'na_vyradenie';
    case VYZISK = 'vyzisk';
    ...
    {
        return match ($this) {
            self::DIEL_NA_VOZE => [self::NA_VYRADENIE, self::VYZISK, self::NA_OPRAVU_NEZARUCNA, self::NA_OPRAVU_ZARUCNA, self::NA_OPRAVU_REKLAMACIA],
    ...
    {
        return match ($this) {
            self::NA_VYRADENIE => 'Na vyradenie',
            self::VYZISK => 'Výzisk',
    ...
    public function requiresApproval(): bool
    {
        return match ($this) {
            ...
            self::NA_OPRAVU_REKLAMACIA => true,
